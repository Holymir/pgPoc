...
npm run cc:start -- contracts
# Make a testing call to create a record in the ledger
# Beware that the first call may fail with a timeout! Just happens the first time
hurl invoke contracts contracts_create "{\"name\":\"my first request\",\"id\":\"0001\",\"created\":0,\"modified\":0}"
```
...
npm run cc:package -- contracts org1
# Install to your blockchain - From the root of your project
hurl install contracts node -P ./chaincode-contracts
# Install in debug mode, this will run the chaincode server locally so you can debug
hurl install contracts node -P ./chaincode-contracts --debug

# Upgrade your existing chaincode - From the root of your project
hurl upgrade contracts node 1.2 -P ./chaincode-contracts
```
...
# Upgrade your existing chaincode - From the root of your project
npm run cc:upgrade -- contracts 1.2
```
